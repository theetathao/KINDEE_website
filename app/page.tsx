...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      const spoonIn = phase(progress, -0.012, 0.006);
      ...
      const passionLead = phase(progress, -0.009, 0.006) * firstFade;
      const passionBody = phase(progress, -0.004, 0.014) * firstFade;
      const passionNote = phase(progress, 0.002, 0.022) * firstFade;
      ...
      set('--passion-lead-y', `${(1 - phase(progress, -0.009, 0.006)) * 42}px`);
      set('--passion-body', passionBody);
      set('--passion-body-y', `${(1 - phase(progress, -0.004, 0.014)) * 42}px`);
